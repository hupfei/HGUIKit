...
- (void)applyConfigurationTemplate {
    ...
    if (!disclosureIndicatorImage) disclosureIndicatorImage = [UIImage qmui_imageWithShape:QMUIImageShapeDisclosureIndicator size:CGSizeMake(6, 10) lineWidth:1 tintColor:UIColorMake(173, 180, 190)];
...
#pragma mark - Plain TableView
    ...
    QMUICMI.tableViewCellSelectedBackgroundColor = nil;  // TableViewCellSelectedBackgroundColor : QMUITableViewCell 点击时的背景色
...
- (UIColor *)themeTintColor {
    return UIColorMake(49, 189, 243);
}

- (UIColor *)themeTitleTextColor {
    return UIColorMake(53, 60, 70);
}

- (UIColor *)themeMainTextColor {
    return UIColorMake(93, 100, 110);
}

- (UIColor *)themeDescriptionTextColor {
    return UIColorMake(153, 160, 170);
}

- (UIColor *)themePlaceholderColor {
    return UIColorMake(196, 200, 208);
}
